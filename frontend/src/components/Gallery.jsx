      ...
      <section id="galeria" className="py-20 bg-gradient-to-br from-gray-50 to-slate-100">
        <div className="container mx-auto px-6 flex items-center justify-center">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-xl text-slate-600">Carregando galeria...</span>
          </div>
        </div>
      </section>
    );
    ...
    return (
      <section id="galeria" className="py-20 bg-gradient-to-br from-gray-50 to-slate-100">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-slate-800 mb-6">GALERIA</h2>
          <p className="text-red-600">Erro ao carregar galeria</p>
        </div>
      </section>
    );
  }
      ...
      <div className="container mx-auto px-6">
        ...
        {gallery.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-xl text-slate-600">Galeria em construção</p>
            <p className="text-slate-400 mt-2">Em breve mais fotos!</p>
          </div>
        ) : (
          <>
            {/* Gallery Grid */}
